...
spectre.characters = Object.freeze({
    ...
    V: "AEO",
    C: "BCDFGHJKMNPQRSTWXZ",
    v: "aeo",
    c: "bcdfghjkmnpqrstwxz",
    A: "AEOBCDFGHJKMNPQRSTWXZ",
    a: "aeobcdfghjkmnpqrstwxz",
    n: "23456789",
    o: "@&%?,=[]_:-+*#!;()/.",
    x: "AEOaeoBCDFGHJKMNPQRSTWXZbcdfghjkmnpqrstwxz23456789@&%?,=[]_:-+*#!;()/.",
    ' ': " ",
});
spectre.characters2 = Object.freeze({
    V: "AE",
    C: "BCDFGHJKMNPQRSTWXZ",
    v: "ae",
    c: "bcdfghjkmnpqrstwxz",
    A: "AEBCDFGHJKMNPQRSTWXZ",
    a: "aebcdfghjkmnpqrstwxz",
    n: "23456789",
    o: "@&%?,=[]_:-+*#!;()/.",
    x: "AEaeBCDFGHJKMNPQRSTWXZbcdfghjkmnpqrstwxz23456789@&%?,=[]_:-+*#!;()/.",
    ' ': " ",
});
spectre.identicons = Object.freeze({
    ...
    // pris sur https://github.com/aerelloth/Cadavres-exquis/blob/master/script.js
    sujet: [
        'Alexandre le Grand',
        'Chuck Norris',
        'Le père Noël',
